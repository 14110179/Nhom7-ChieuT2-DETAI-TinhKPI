...
<meta charset="utf-8">
      ...
      <link rel="stylesheet" type="text/css" href="Style.css">
        ...
        $(document).ready(function(){
        	$.get('HieuTruongXemBieuMau',{MAGV : $(this).find(":selected").val()},function(responseText){
...
<body>
<%	session.setAttribute("trangload","XemBieuMau_HieuTruong.jsp"); %>
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
     ...
     <% 
     	...
     	dsgv=mt.getAllTruongKhoa();
     %>
     <form action="HieuTruongChamDiem" method="post">
