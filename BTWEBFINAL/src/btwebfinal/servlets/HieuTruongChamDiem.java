...
@WebServlet("/HieuTruongChamDiem")
public class HieuTruongChamDiem extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public HieuTruongChamDiem() {
        super();
		...
		String load=session.getAttribute("trangload").toString();						
			...
			for(DSTieuChi tc : dstieuchi3)
				{			
					...
					try {												
							chamdiem.UpdateDiemSoHieuTruong(matc, diemso, "BM2016-2017", nth);												
					} catch (Exception e) {
