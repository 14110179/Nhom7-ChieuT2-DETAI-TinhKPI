...
public class TruongKhoaXemBieuMau extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int i=0;
		int j=0;
		html += "<tr style='height: auto;' colspan='4'><td  height='10px'><table cellspacing='0' cellpadding='4' border='0'  class='table'><tr align='center' style='height:auto;'><td> A : Giảng Viên</td><td> B : Trưởng bộ môn</td>  <td> C : Trưởng khoa</td></tr></table></td><td>A</td><td>B</td><td>C</td></tr>";
