      ...
      <table id="" cellspacing="0" cellpadding="4" border="3"  class="table table-responsive"  style="no-repeat; color:#333333; text-align: justify;" align="center">
   		...
   		<thead>
   		   	<tr align="center" style=" color:White;background-color:#507CD1;font-size:10pt;font-weight:bold;">
       			<th  colspan="3"  scope="col" style="width:auto;"><p align="center">Phiếu Đăng Ký</p></th> 
       	...
       	<tbody>		
       	<tr>
       		<td>sssssssssssssssssssssssssssssssssss</td>
       		<td>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</td>
       	</tr>
       		<%-- <%
