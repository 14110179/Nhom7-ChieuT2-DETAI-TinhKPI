...
<%	session.setAttribute("trangload","DangKyMucTieuCaNhan_GiangVien.jsp"); %>
    ...
    <form action="ChamDiemBieuMau" method="post">
       				...
       				for(DSTieuChi tc : dstieuchi1)
       				{
       					...
       					<tr>
       						...
       						<td>
       							...
       							<option selected="selected" value="<%=tc.getDiemTruongBoMon()%>" ><%=tc.getDiemTruongBoMon()%></option>       							
       							</select>
       						</td>      	    					
       						<td>
       							<select disabled="disabled">
        							<option selected="selected" value="<%=tc.getDiemTruongKhoa()%>" ><%=tc.getDiemTruongKhoa()%></option>       	
       							</select>
       						</td>      	
       					</tr>
       		<%
    	...
    	<tfoot>
      		<tr align="center">
      			<td colspan="4">
      				<button type="submit" name="btn" value="giangvien" id="taontc" class="btn btn-primary" >Xác Nhận</button>
      			</td>
      		</tr>
    	</tfoot>
    </table>
